...
| Benefit                                                                              | Enhancing | Wondrous | Superb | Legendary |
| ------------------------------------------------------------------------------------ | --------- | -------- | ------ | --------- |
...
Alternatively, the cook can bring forth exotic properties of the creature, conferring one trait of the cooked animal to those that consume it as per the following table (this replaces the benefit to ability checks and saves):

| Minimum Rarity | Creature Boon                                          |
| -------------- | ------------------------------------------------------ |
| Meat           | Hold Breath, Keen Senses, Pounce,<br>Stone Camouflage  |
| Hearty         | Amphibious/Water Breathing, Web<br>Walker              |
| Superb         | Pack Tactics, Spider Climb                             |
...
| Element   | Benefit                                                                                                         |
| --------- | --------------------------------------------------------------------------------------------------------------- |
| Cold      | Advantage on saves against cold climates<br>and resistance to cold damage.                                      |
| Fire      | Advantage on saves against hot climates<br>and resistance to fire damage.                                       |
